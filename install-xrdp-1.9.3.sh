...
if [[ $version=*"Ubuntu 16.04.7"* ]]; then
echo
...
echo
#-------------------------------------------------------------------------------------------------------------------------------------#
# Step 10 – Install XServer xorg to fix the no keyboard/mouse response after xrdp packages installation
#-------------------------------------------------------------------------------------------------------------------------------------#
/bin/echo -e “\e[1;32mInstalling xserver xorg\e[0m”
sudo apt-get -y install xserver-xorg-input-all
